...
def obs_service_get_max_res_fps(service: 'obs_service_t const *', cx: 'int *', cy: 'int *', fps: 'int *') -> "void":
    return _obspython.obs_service_get_max_res_fps(service, cx, cy, fps)
obs_service_get_max_res_fps = _obspython.obs_service_get_max_res_fps
